...
export default function LandingPage () {
    ...
    return (
        <div className='container-Home'>
            ...
            <Link className='container-ButtonAllProducts__Landing' to='/category' style={{ textDecoration: 'none' }} target="_blank" rel="noreferrer noopener">ALL PRODUCTS</Link>
            ...
            <div className='container-AboutUs__Landing'>
                ...
                <div className='paragraph-AboutUs'>
                    ...
                    <p>En el TeroExpress distribuimos una amplia gama de artículos de lujo para beber Mate, nuestros productos son hechos artesanalmente por manos laboriosas generadoras de emociones únicas como tu. Contamos con 10 tiendas en América Latina y nuestra proyección es llegar a toda Latam. Danos el placer de atenderte.</p>
                </div>
            </div>
            ...
            <div className='container-SocialNetwork__Landing'>
                ...
                <a href="https://www.youtube.com/@eltero309/" target="_blank" rel="noreferrer noopener">
            ...
            <div className='image-Costumbres'>
                <img src="https://http2.mlstatic.com/D_NQ_NP_764029-MLA50247059281_062022-OO.webp" alt="Imagen" />
            </div>

            <div className='container-Info__Landing'>
                <div className='info__Landing'>
                    <p>¿Te arrepentiste de comprar?</p>
                    <Link to='/purchaseCanceled' style={{ textDecoration: 'none' }} target="_blank" rel="noreferrer noopener">
                        <span>¿Cómo cancelar una compra?</span>
                    </Link>
                </div>
                <div className='info__Landing'>
                    <p>¿Conocés las normas que protegen tus compras?</p>
                    <Link to='/consumerDefense' style={{ textDecoration: 'none' }} target="_blank" rel="noreferrer noopener">
                        <span>Contratos de adhesión - Ley Nº 24.240 de Defensa del Consumidor</span>
                    </Link>
                </div>
            </div>
            ...
            <div className='container-Additional__InfoLanding'>
                <div className='box-Additional__InfoLanding'>
                    <Link className='additional-Info__Landing' to='/meansOfPayment' style={{ textDecoration: 'none' }} target="_blank" rel="noreferrer noopener">
                ...
                <div className='box-Additional__InfoLanding'>
                    <a className='additional-Info__Landing' href="https://www.fedex.com/es-co/tracking.html" target="_blank" rel="noreferrer noopener">
                ...
                <div className='box-Additional__InfoLanding'>
                    <Link className='additional-Info__Landing' to='/returnsExchanges' style={{ textDecoration: 'none' }} target="_blank" rel="noreferrer noopener">
