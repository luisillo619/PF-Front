        ...
        {!loading && (
            <div >
                            ...
                            <div className="specification-Details">
                                ...
                                <div className="price-Paragraph__Details">
                                    ...
                                    <div className="paragraph-Details">
                                        <p>12 cuotas de USD { trunc(productDetail.price / 12, 3) } </p>
                                        <p>36 cuotas de USD { trunc(productDetail.price / 36, 3) } </p>
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <div className="container-FedEx">
                                        ...
                                        <p>Consulta los tiempos de entrega <a href="https://www.fedex.com/es-co/home.html" target="_blank" rel="noreferrer noopener">aquí.</a></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                <div className="container-CartButton">
                    ...
                    <button className="button-ProductDetails" onClick={handleClick}>AÑADIR AL CARRITO</button>
                    {count > 1 && ( 
                        <button className="button-AiOutlineMinus" onClick={subtractionHandler}  ><AiOutlineMinus /></button> )}
                ...
                <div className="protectedPurchase">
                    <span className="span-ProtectedPurchase"><Link to='/protectedPurchase' style={{ textDecoration: 'none' }} target="_blank" rel="noreferrer noopener">Compra Protegida</Link></span>
                ...
                <div className="meansOfPayment">
                    <div className="meansOfPaymentUno">
                        <p>Medios de Pago</p>
                        <Link to='/meansOfPayment' style={{ textDecoration: 'none' }} target="_blank" rel="noreferrer noopener">
                            <button className="buttonMeansOfPaymentUno">Consulta los medio de pago aquí</button>
                        </Link>
                    </div>
